    ...
    <form id="form1" runat="server">
        <div>
            <dx:ASPxPanel ID="ASPxPanel1" runat="server" Width="100%" CssClass="AnswerPanel" EncodeHtml="false">
                ...
                <PanelCollection>
                    <dx:PanelContent>
                        <dx:ASPxLabel Font-Size="Medium" runat="server" Text="Step 1. Contractor WHS Management System Questionnaire"></dx:ASPxLabel>
                        <br />
                        <br />
                        <dx:ASPxLabel runat="server" Text="This questionnaire forms part of our evaluation process and is to be completed and submitted prior to final selection being made. The objective of the questionnaire is to provide an overview of the status of your systems. You may be required to verify responses noted in the questionnaire by providing evidence of your ability and capacity in relevant matters."></dx:ASPxLabel>
                    </dx:PanelContent>
                </PanelCollection>
            </dx:ASPxPanel>
